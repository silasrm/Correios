...
require_once 'Correios/Ect/Prdt/ECTFormatos.php';
require_once 'Correios/Ect/Prdt/ECTServicos.php';
require_once 'Correios/Ect/EctAPI.php';
require_once 'Correios/Ect/Prdt/ECTServico.php';

/**
 * @brief	Cálculo de preços e prazos de entrega de encomendas
 * @author	João Batista Neto <neto.joaobatista@imasters.com.br>
 */
class Correios_Ect_Prdt_Prdt extends Correios_Ect_EctAPI {
	/**
	 * @var string
	 */
	private $nCdEmpresa;
	...
	public function __construct( Correios_Ect_ECT $ect ) {
		...
		$this->setNCdEmpresa( '' );
		$this->setNCdFormato( Correios_Ect_Prdt_ECTFormatos::FORMATO_CAIXA_PACOTE );
		$this->setNVlAltura( 0 );
	...
	public function call() {
		...
		foreach ( $xpath->query( './/cServico' ) as $cServico ) {
			$ectServico = new Correios_Ect_Prdt_ECTServico();
	 ...
	 * @return	Correios_Ect_Prdt_ECTServico
	 */
	public function getServicos() {
		return new Correios_Ect_Prdt_ECTServico();
	}
}