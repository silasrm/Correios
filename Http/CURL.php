...
require_once 'Correios/Http/HTTPResponse.php';
 ...
 */
class Correios_Http_CURL implements Correios_Http_HTTPRequest {
	/**
	 * @var	resource
	 */
	 ...
	 */
	public function authenticate( Correios_Http_HTTPAuthenticator $authenticator ) {
	...
	public function execute( $path = '/' , $method = Correios_Http_HTTPRequestMethod::GET ) {
		...
		switch ( $method ) {
			case Correios_Http_HTTPRequestMethod::PUT :
			case Correios_Http_HTTPRequestMethod::POST :
				if ( $method != Correios_Http_HTTPRequestMethod::POST ) {
				...
				break;
			case Correios_Http_HTTPRequestMethod::DELETE :
			case Correios_Http_HTTPRequestMethod::HEAD :
			case Correios_Http_HTTPRequestMethod::OPTIONS:
			case Correios_Http_HTTPRequestMethod::TRACE:
				curl_setopt( $this->curlResource , CURLOPT_CUSTOMREQUEST , $method );
			case Correios_Http_HTTPRequestMethod::GET:
				if ( $hasParameters ) {
					$targetURL .= '?' . $query;
				}
		...
		$this->httpResponse = new Correios_Http_HTTPResponse();
	 ...
	 */
	public function open( Correios_Http_HTTPConnection $httpConnection ) {
